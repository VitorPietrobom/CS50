...
class CrosswordCreator():
        ...
        if arcs == None:
            ...
            for x in self.domains:
                for y in self.domains:
                    if (x != y) and ((x,y) not in arcs) and ((y,x) not in arcs):
        ...
        for arc in arcs:
            ...
            if revised:
                ...
                for z in self.crossword.variables:
                    if z != arc[0] and ((z, arc[0]) not in arcs) and ((arc[0], z) not in arcs):
                        arcs.append(tuple(z, arc[0]))
        ...
        for variable in assignment:
            ...
            for other_variable in assignment:
                if other_variable != variable:
                    if assignment[variable] == assignment[other_variable]:
                        return False
    ...
    def select_unassigned_variable(self, assignment):
        ...
        return values.
        """
        return min([var for var in self.crossword.variables if var not in assignment], key=lambda var: (len(self.domains[var]), -len(self.crossword.neighbors(var))))
        raise NotImplementedError
